package eu.technest.virx.repository;

import eu.technest.virx.WebtorrentApp;
import eu.technest.virx.config.Constants;
import eu.technest.virx.config.audit.AuditEventConverter;
import eu.technest.virx.domain.PersistentAuditEvent;
...
import static eu.technest.virx.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
